    ...
    return <Transition>
        {
            loader ? <Khuleelge/> : <div className="left-0 top-0 w-screen h-screen bg-fixed bg-cover relative flex justify-center items-center overflow-hidden" style={{background: `url(${zurag.src})`}}>
                ...
                <div className=' absolute w-full h-full z-10 rounded-full !shadow-[inset_0_0_200px_200px_rgba(0,0,0,1)] 2xl:!shadow-[inset_0_0_300px_300px_rgba(0,0,0,1)]' style={{scale: '1.3'}}/>
